...
async function merge(campaign){
    ...
    const imagesRoot = 'https://playground.infomaxim.com/nib/images/'
    const url = 'https://playground.infomaxim.com/nib/september.html';
    ...
    fs.writeFileSync("C:\\Users\\andy\\Downloads\\" + campaign.title + "OctNov22.msg", newMessage.toBytes());
